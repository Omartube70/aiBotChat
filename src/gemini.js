...
export async function interpretStaffCommand(text, customers, quotes) {
  ...
  const prompt =
    ...
    `  ولو ذكر أكتر من زبون ("كلّم هاني وإسلام وعمر") حط كل واحد في "targets":["هاني","إسلام","عمر"].\n` +
        ...
        parts: [
          ...
          },
          {
            text:
              ...
              'وأحيانًا المتكلم صاحب المحل بيدّي أوامر، وعبارات زي دي بتتقال كتير: "بقاله كتير"، "ما بياخدش بضاعة"، "ابعتله رسالة"، ' +
              '"اللي كان بيكلمك من شوية"، "قوله"، "الرواتب"، "موظف"، "سلفة"، "فاتورة"، "عرض سعر".',
          },
        ],
      },
    ],
